...
class BurnWeightTests(unittest.TestCase):
    def test_burn_configuration_targets_twenty_percent(self):
        self.assertAlmostEqual(BURN_FRACTION, 0.20, places=6)
        self.assertAlmostEqual(KEEP_FRACTION, 0.80, places=6)
